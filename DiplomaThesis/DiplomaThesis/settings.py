"""
Django settings for DiplomaThesis project.
...
SECRET_KEY = '15oemynwqqd=%=%yzjafm9yi4k9903cwzfdol!1%^xewnm#%y('
...
ROOT_URLCONF = 'DiplomaThesis.urls'
...
WSGI_APPLICATION = 'DiplomaThesis.wsgi.application'
