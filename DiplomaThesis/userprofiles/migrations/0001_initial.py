# Generated by Django 2.1.7 on 2019-04-06 13:59
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('father_name_el', models.CharField(blank=True, max_length=100, null=True, verbose_name='Πατρώνυμο στα Ελληνικά')),
                ('father_name_en', models.CharField(blank=True, max_length=100, null=True, verbose_name='Πατρώνυμο στα Αγγλικά')),
