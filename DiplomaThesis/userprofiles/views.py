...
class GAUserUpdateView(UpdateView):
    model = GAUser
    fields = ['name_el', 'name_en', 'father_name_el', 'father_name_en', 'surname_el', 'surname_en', 'title']
    ...
    def get_form(self, form_class=None):
        ...
        form.fields['father_name_el'].required = True
        form.fields['father_name_en'].required = True
